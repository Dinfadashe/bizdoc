// Auto-generated receipt page (publicly accessible via link)
"use client";
...
export default function ReceiptPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--cream)", fontFamily: "var(--font-body)" }}>
      {/* Print button */}
      <div className="no-print" style={{ maxWidth: 700, margin: "0 auto", padding: "24px 20px 0", display: "flex", justifyContent: "flex-end", gap: 10 }}>
          ...
          <div style={{ background: "var(--green)", padding: "28px 32px", display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
            ...
            <div style={{ textAlign: "right" }}>
              ...
              <div style={{ marginTop: 10 }}>
                <span style={{ background: "#e8f5ef", color: "#1a6b4a", padding: "4px 12px", borderRadius: 20, fontSize: 11, fontWeight: 700, textTransform: "uppercase" as const }}>
                  PAID
                </span>
              </div>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24, marginBottom: 24 }}>
              <div>
                ...
                <div style={{ color: "#555", fontSize: 13, marginTop: 4, lineHeight: 1.7 }}>
                  {invoice.client_email}<br />{invoice.client_address}
                </div>
              </div>
              <div>
            ...
            <div style={{ display: "flex", justifyContent: "flex-end" }}>
              <div style={{ width: 260 }}>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", fontFamily: "var(--font-display)", fontSize: 20, fontWeight: 700, borderTop: "2px solid var(--green)", paddingTop: 10, marginTop: 6 }}>
                  <span>Amount Paid</span><span style={{ color: "var(--green)" }}>{formatCurrency(invoice.total, invoice.currency)}</span>
                </div>
              </div>
            </div>
          </div>
