...
// Update the PATCH invoice route to deduct inventory on paid
const content = [
...
fs.writeFileSync('app/api/invoices/[id]/route.ts', content, { encoding: 'utf8' });
console.log('Done invoice PATCH route');