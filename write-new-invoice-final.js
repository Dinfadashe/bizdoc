...
fs.writeFileSync('app/invoices/new/page.tsx', content, 'utf8');

const result = fs.readFileSync('app/invoices/new/page.tsx', 'utf8');
console.log('Save as Draft button:', result.includes('Save as Draft'));
console.log('handleSave:', result.includes('handleSave'));
console.log('doSave:', result.includes('doSave'));
console.log('Lines:', result.split('\n').length);
console.log(result.includes('Save as Draft') ? 'SUCCESS' : 'FAILED');